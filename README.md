...
default:
	$(MAKE) -C $(KDIR) M=$$PWD
	cp hello111.ko hello111.ko.unstripped
	cp hello222.ko hello222.ko.unstripped
	$(CROSS_COMPILE)strip -g hello111.ko
	$(CROSS_COMPILE)strip -g hello222.ko
clean:
